...
export const PERMISSIONS = {
  ...
  CONSTRUCTION_RATES_VIEW: 'construction.rates.view',
  CONSTRUCTION_RATES_MANAGE: 'construction.rates.manage',
  CONSTRUCTION_RATES_VERIFY: 'construction.rates.verify',
  CONSTRUCTION_SOURCES_MANAGE: 'construction.sources.manage',
  CONSTRUCTION_IMPORT: 'construction.import',
  CONSTRUCTION_SETTINGS_MANAGE: 'construction.settings.manage',
  // Automobile
