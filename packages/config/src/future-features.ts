...
export const FUTURE_FEATURES_LAST_UPDATED = '2026-08-20';
...
export const FUTURE_FEATURES: FutureFeature[] = [
  ...
  },
  {
    ...
    status: 'deferred',
    notes:
      'TipTap rich editor satisfies Sprint 2; future: slash menu, block drag handles, embed blocks',
  },
  {
    id: 'cms-form-builder',
    moduleId: 'cms',
  ...
  },
  {
    ...
    moduleId: 'cms',
    category: 'Content',
    title: 'Plugin-based content types',
    priority: 'low',
    status: 'backlog',
  },
  {
  ...
  {
    id: 'cms-contributor-role',
    moduleId: 'cms',
    category: 'Workflow',
    title: 'Dedicated Contributor role',
    priority: 'medium',
    status: 'backlog',
    phase: 5,
  },
  {
    id: 'cms-reviewer-role',
    moduleId: 'cms',
    category: 'Workflow',
    title: 'Dedicated Reviewer role',
    priority: 'medium',
    status: 'backlog',
    phase: 5,
  },
  {
    id: 'cms-approval-chains',
    moduleId: 'cms',
    category: 'Workflow',
    title: 'Formal workflow approval chains',
    priority: 'medium',
    status: 'backlog',
  },
  {
  ...
  },
  {
    ...
    moduleId: 'cms',
    category: 'Search',
    title: 'Dedicated full-text search index',
    priority: 'medium',
    status: 'backlog',
  },
  {
    ...
    title: 'Redis-backed cache / search',
    priority: 'medium',
    status: 'backlog',
  },
  {
    ...
    moduleId: 'cms',
    category: 'AI',
    title: 'AI-assisted drafting and SEO suggestions',
    priority: 'medium',
    status: 'backlog',
    phase: 4,
  },
  {
    id: 'cms-personalization',
    moduleId: 'cms',
    category: 'Analytics',
  ...
  {
    id: 'ads-cpm-reporting',
    moduleId: 'ads',
    category: 'Reporting',
    title: 'CPM/CPC automated reporting',
    priority: 'medium',
    status: 'backlog',
  },
  {
  ...
  },
  {
    ...
    moduleId: 'ads',
    category: 'Portal',
    title: 'Advertiser self-service portal',
    priority: 'medium',
    status: 'backlog',
    phase: 7,
  },
  ...
  {
    id: 'ads-ai-optimization',
    moduleId: 'ads',
    category: 'AI',
    title: 'AI-based ad optimization',
    priority: 'low',
    status: 'backlog',
    phase: 4,
  },
  {
    id: 'ads-geo-targeting',
    moduleId: 'ads',
    category: 'Targeting',
  ...
  {
    id: 'ads-budget-enforcement',
    moduleId: 'ads',
    category: 'Ops',
    title: 'Campaign budget enforcement',
    priority: 'medium',
    status: 'backlog',
  },
  ...
  },
  {
    ...
    moduleId: 'theme',
    category: 'Ops',
    title: 'Scheduled theme activation',
    priority: 'low',
    status: 'backlog',
  },
  ...
  },
  {
    ...
    moduleId: 'media',
    category: 'Storage',
    title: 'S3-compatible external storage',
    priority: 'low',
    status: 'backlog',
  },
  {
    id: 'media-multi-tenant',
    moduleId: 'media',
    category: 'Enterprise',
    title: 'Multi-tenant media libraries',
    priority: 'medium',
    status: 'backlog',
    phase: 9,
  },
  ...
  // 14 Finance
  {
    id: 'finance-live-rates',
    moduleId: 'finance',
    category: 'Data',
    title: 'Live interest rate feeds',
    priority: 'high',
    status: 'backlog',
    phase: 2,
  },
  ...
  },
  {
    ...
    moduleId: 'finance',
    category: 'Marketplace',
    title: 'Financial calculators marketplace',
    priority: 'medium',
    status: 'backlog',
    phase: 3,
  },
  {
    ...
    moduleId: 'finance',
    category: 'User',
    title: 'User portfolios and goal planning',
    priority: 'low',
    status: 'backlog',
    phase: 5,
  },
  ...
  // 15 Construction
  {
    id: 'construction-live-prices',
    moduleId: 'construction',
    category: 'Data',
    title: 'Live regional material prices',
    priority: 'high',
    status: 'backlog',
    phase: 2,
  },
  {
    id: 'construction-supplier-inventory',
    moduleId: 'construction',
    category: 'Integrations',
    title: 'Supplier inventory integration',
    priority: 'medium',
    status: 'backlog',
  },
  {
    id: 'construction-ai-estimate',
    moduleId: 'construction',
    category: 'AI',
  ...
  },
  {
    ...
    title: 'AR room and material previews',
    priority: 'low',
    status: 'backlog',
  },
  {
    id: 'construction-marketplace',
    moduleId: 'construction',
    category: 'Marketplace',
  ...
  // 16 Automobile
  {
    id: 'auto-live-pricing',
    moduleId: 'automobile',
    category: 'Data',
    title: 'Live vehicle pricing',
    priority: 'high',
    status: 'backlog',
    phase: 2,
  },
  ...
  },
  {
    ...
    moduleId: 'automobile',
    category: 'Integrations',
    title: 'EV charging network integration',
    priority: 'low',
    status: 'backlog',
  },
  {
  ...
  },
  {
    ...
    moduleId: 'automobile',
    category: 'Marketplace',
    title: 'Used vehicle marketplace',
    priority: 'medium',
    status: 'backlog',
    phase: 7,
  },
  {
    id: 'auto-ai-recommend',
    moduleId: 'automobile',
    category: 'AI',
    title: 'AI vehicle recommendation engine',
    priority: 'medium',
    status: 'backlog',
    phase: 4,
  },
  ...
  // 17 Reviews
  {
    id: 'reviews-ai-summary',
    moduleId: 'reviews',
    category: 'AI',
    title: 'AI-generated review summaries',
    priority: 'medium',
    status: 'backlog',
    phase: 4,
  },
  ...
  },
  {
    ...
    moduleId: 'reviews',
    category: 'Trust',
    title: 'Verified purchase integrations',
    priority: 'medium',
    status: 'backlog',
  },
  {
  ...
  },
  {
    ...
    moduleId: 'reviews',
    category: 'Community',
    title: 'Reviewer reputation system',
    priority: 'medium',
    status: 'backlog',
    phase: 5,
  },
  ...
  // 18 Comparison
  {
    id: 'comparison-ai-summary',
    moduleId: 'comparison',
    category: 'AI',
    title: 'AI-generated comparison summaries',
    priority: 'medium',
    status: 'backlog',
    phase: 4,
  },
  {
    id: 'comparison-live-pricing',
    moduleId: 'comparison',
    category: 'Data',
  ...
  {
    id: 'comparison-user-built',
    moduleId: 'comparison',
    category: 'User',
    title: 'User-selected custom comparisons',
    priority: 'medium',
    status: 'backlog',
    phase: 3,
  },
  {
    ...
    moduleId: 'comparison',
    category: 'User',
    title: 'Saved comparison lists',
    priority: 'medium',
    status: 'backlog',
    phase: 3,
  },
  {
    id: 'comparison-voting',
    moduleId: 'comparison',
    category: 'Community',
  ...
  // 19 Directory
  {
    ...
    moduleId: 'directory',
    category: 'Workflow',
    title: 'Claim listing workflow',
    priority: 'high',
    status: 'backlog',
    phase: 7,
  },
  {
    id: 'directory-subscriptions',
    moduleId: 'directory',
    category: 'Monetization',
  ...
  // 20 AI Tools
  // Public discovery (footer / primary nav) is intentionally deferred until the module is launch-ready.
  {
    id: 'ai-tools-public-nav',
    moduleId: 'ai-tools',
    category: 'Launch',
    title: 'Restore AI Tools in public footer and primary navigation',
    priority: 'high',
    status: 'deferred',
    notes:
      'Removed from site footer (Aug 2026). Do not re-add to SiteFooter resources, CMS footer menus, or primary header nav until catalog quality, monetization rules, and launch checklist are ready. Routes under /ai-tools may remain for internal/admin use.',
  },
  {
    id: 'ai-tools-public-launch',
    moduleId: 'ai-tools',
    category: 'Launch',
    title: 'Public AI Tools module launch (catalog UX, SEO, trust labeling)',
    priority: 'high',
    status: 'deferred',
    phase: 4,
    notes:
      'Ship a production-ready /ai-tools hub before surfacing in footer, header, About product grid, or homepage AI sections. Include sponsored disclosure, empty-state quality, and content inventory gates.',
  },
  {
    id: 'ai-tools-status',
    moduleId: 'ai-tools',
  ...
  {
    id: 'ai-tools-playgrounds',
    moduleId: 'ai-tools',
    category: 'UX',
    title: 'Embedded AI playgrounds',
    priority: 'medium',
    status: 'backlog',
    phase: 4,
  },
  ...
  },
  {
    ...
    moduleId: 'search',
    category: 'Integrations',
    title: 'Federated search across partner APIs',
    priority: 'low',
    status: 'backlog',
  },
  ...
  },
  {
    ...
    moduleId: 'analytics',
    category: 'Advanced',
    title: 'Cohort and funnel analysis',
    priority: 'medium',
    status: 'backlog',
  },
  {
  ...
  },
  {
    ...
    title: 'Data warehouse / BigQuery export',
    priority: 'medium',
    status: 'backlog',
  },
  {
    ...
    moduleId: 'analytics',
    category: 'Reporting',
    title: 'Scheduled recurring report delivery',
    priority: 'medium',
    status: 'backlog',
  },
  ...
  },
  {
    ...
    moduleId: 'seo',
    category: 'i18n',
    title: 'Multilingual SEO / hreflang',
    priority: 'high',
    status: 'backlog',
    phase: 2,
  },
  ...
  },
  {
    ...
    moduleId: 'seo',
    category: 'Integrations',
    title: 'Live Google Search Console API sync',
    priority: 'medium',
    status: 'backlog',
  },
  ...
  // 24 Notifications
  {
    ...
    category: 'User',
    title: 'Per-user channel preferences',
    priority: 'medium',
    status: 'backlog',
    phase: 5,
  },
  {
    ...
    title: 'Async email queue (BullMQ + Redis)',
    priority: 'medium',
    status: 'backlog',
  },
  {
  ...
  },
  {
    ...
    moduleId: 'notifications',
    category: 'Realtime',
    title: 'Real-time delivery (SSE/WebSocket)',
    priority: 'medium',
    status: 'backlog',
  },
  {
    ...
    moduleId: 'notifications',
    category: 'Integrations',
    title: 'Delivery webhooks and analytics',
    priority: 'low',
    status: 'backlog',
  },
  ...
  {
    id: 'premium-public-nav',
    moduleId: 'users',
    category: 'Launch',
    title: 'Restore Premium in public footer navigation',
    priority: 'high',
    status: 'deferred',
    phase: 6,
    notes:
      'Removed from site footer Resources (Aug 2026). Re-add /premium only after membership plans, billing UX, and public pricing page are launch-ready.',
  },
  {
    id: 'users-badges',
    moduleId: 'users',
    category: 'Community',
    title: 'User badges and gamification',
    priority: 'medium',
    status: 'backlog',
    phase: 5,
  },
  ...
  },
  {
    ...
    moduleId: 'settings',
    category: 'Enterprise',
    title: 'Tenant-specific settings',
    priority: 'high',
    status: 'backlog',
    phase: 9,
  },
  ...
  {
    id: 'developers-public-nav',
    moduleId: 'api',
    category: 'Launch',
    title: 'Restore Developers in public footer navigation',
    priority: 'medium',
    status: 'deferred',
    phase: 9,
    notes:
      'Removed from site footer Resources (Aug 2026). Re-add /developers only after the public developer portal (docs, keys, rate limits) is launch-ready.',
  },
  {
    id: 'api-marketplace',
    moduleId: 'api',
    category: 'Monetization',
    title: 'API marketplace and monetization',
    priority: 'medium',
    status: 'backlog',
    phase: 9,
  },
  ...
  },
  {
    ...
    moduleId: 'api',
    category: 'Enterprise',
    title: 'API quotas and usage billing',
    priority: 'medium',
    status: 'backlog',
    phase: 9,
  },
  ...
  {
    id: 'docker-multi-arch',
    moduleId: 'docker',
    category: 'Build',
    title: 'Multi-architecture / ARM images',
    priority: 'medium',
    status: 'backlog',
  },
  {
    ...
    moduleId: 'docker',
    category: 'Build',
    title: 'Remote BuildKit / distributed builds',
    priority: 'low',
    status: 'backlog',
  },
  ...
  },
  {
    ...
    moduleId: 'performance',
    category: 'AI',
    title: 'Automatic tuning recommendations',
    priority: 'low',
    status: 'backlog',
  },
  ...
  // Platform-wide (master planning + roadmap themes)
  {
    ...
    moduleId: 'platform',
    category: 'i18n',
    title: 'Multi-language content platform',
    priority: 'high',
    status: 'backlog',
    phase: 2,
  },
  ...
  {
    id: 'platform-calc-marketplace',
    moduleId: 'platform',
    category: 'Marketplace',
    title: 'Third-party calculator marketplace',
    priority: 'medium',
    status: 'backlog',
    phase: 3,
  },
  ...
  },
  {
    ...
    moduleId: 'platform',
    category: 'Monetization',
    title: 'Courses and digital downloads',
    priority: 'medium',
    status: 'backlog',
    phase: 6,
  },
  {
    id: 'platform-vector-db',
    moduleId: 'platform',
    category: 'Data',
  ...
  {
    id: 'platform-admin-prompts',
    moduleId: 'platform',
    category: 'Developer',
    title: 'Admin developer prompts UI',
    priority: 'low',
    status: 'deferred',
    notes: 'Spec 35 — future',
  },
];
