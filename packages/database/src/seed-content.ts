...
const ARTICLE_TOPICS: ArticleSeed[] = [
  ...
  {
    slug: 'how-to-buy-first-house',
    title: 'How to Buy Your First House in India',
    categorySlug: 'finance',
    excerpt: 'From savings to registration — a first-time buyer checklist.',
  },
  {
    slug: 'best-home-loan-india',
    title: 'Best Home Loan Options in India (2026)',
    categorySlug: 'finance',
    excerpt: 'Compare banks, NBFCs, floating vs fixed rates, and eligibility.',
  },
  {
    slug: 'how-to-save-income-tax',
    title: 'How to Save Income Tax Legally in India',
    categorySlug: 'finance',
    excerpt: 'Section 80C, 80D, HRA, and NPS deductions explained simply.',
  },
  {
    slug: 'what-is-nps',
    title: 'What Is NPS and Should You Invest?',
    categorySlug: 'finance',
    excerpt: 'National Pension System basics, tax benefits, and withdrawal rules.',
  },
  {
    slug: 'sip-basics-guide',
    title: 'SIP Basics for Beginners',
    categorySlug: 'finance',
    excerpt: 'Start a mutual fund SIP with the right amount and horizon.',
  },
  {
    slug: 'personal-loan-vs-credit-card',
    title: 'Personal Loan vs Credit Card EMI',
    categorySlug: 'finance',
    excerpt: 'Which borrowing option costs less for short-term needs.',
  },
  {
    slug: 'cibil-score-improve',
    title: 'How to Improve Your CIBIL Score',
    categorySlug: 'finance',
    excerpt: 'Practical steps to build credit before applying for loans.',
  },
  {
    slug: 'home-loan-prepayment',
    title: 'Home Loan Prepayment: Is It Worth It?',
    categorySlug: 'finance',
    excerpt: 'When partial prepayment saves interest and when it does not.',
  },
  {
    slug: 'car-loan-vs-full-payment',
    title: 'Car Loan vs Full Payment',
    categorySlug: 'finance',
    excerpt: 'Opportunity cost, EMI burden, and dealer offers compared.',
  },
  {
    slug: 'term-insurance-guide',
    title: 'Term Life Insurance Buying Guide',
    categorySlug: 'finance',
    excerpt: 'Cover amount, riders, and claim settlement ratios.',
  },
  {
    slug: 'health-insurance-family',
    title: 'Health Insurance for Families in India',
    categorySlug: 'finance',
    excerpt: 'Floater vs individual plans, room rent limits, and super top-up.',
  },
  {
    slug: 'mutual-fund-taxation',
    title: 'Mutual Fund Taxation in India',
    categorySlug: 'finance',
    excerpt: 'LTCG, STCG, and indexation for equity and debt funds.',
  },
  {
    slug: 'ppf-vs-fd',
    title: 'PPF vs Fixed Deposit: Which Is Better?',
    categorySlug: 'finance',
    excerpt: 'Returns, liquidity, and tax treatment compared.',
  },
  {
    slug: 'credit-card-rewards',
    title: 'How to Maximize Credit Card Rewards',
    categorySlug: 'finance',
    excerpt: 'Cashback, miles, and lounge access without overspending.',
  },
  {
    slug: 'gold-loan-vs-personal-loan',
    title: 'Gold Loan vs Personal Loan',
    categorySlug: 'finance',
    excerpt: 'Speed, interest rates, and risk for emergency borrowing.',
  },
  {
    slug: 'education-loan-guide',
    title: 'Education Loan Guide for Indian Students',
    categorySlug: 'finance',
    excerpt: 'Collateral, moratorium, and tax benefits under Section 80E.',
  },
  {
    slug: 'retirement-corpus-india',
    title: 'How Much Retirement Corpus Do You Need?',
    categorySlug: 'finance',
    excerpt: 'Inflation-adjusted targets for urban and tier-2 lifestyles.',
  },
  {
    slug: 'gst-for-small-business',
    title: 'GST Basics for Small Business Owners',
    categorySlug: 'finance',
    excerpt: 'Registration thresholds, returns, and input tax credit.',
  },
  {
    slug: 'income-tax-new-vs-old',
    title: 'New vs Old Tax Regime: Which to Choose?',
    categorySlug: 'finance',
    excerpt: 'Run the numbers before filing ITR for Tax Year 2026–27.',
  },
  {
    slug: 'nps-tier-1-tier-2',
    title: 'NPS Tier 1 vs Tier 2 Explained',
    categorySlug: 'finance',
    excerpt: 'Liquidity, tax benefits, and asset allocation choices.',
  },
  {
    slug: 'construction-cost-bangalore',
    title: 'Construction Cost in Bangalore for 2026',
    categorySlug: 'home-construction',
    excerpt: 'Per-sq-ft ranges for basic, standard, and premium builds.',
  },
  {
    slug: 'construction-cost-mumbai',
    title: 'House Construction Cost in Mumbai',
    categorySlug: 'home-construction',
    excerpt: 'Material and labour rates in the Mumbai metropolitan region.',
  },
  {
    slug: 'vastu-for-home-plan',
    title: 'Vastu Tips for Home Floor Plans',
    categorySlug: 'home-construction',
    excerpt: 'Room placement ideas that work with modern layouts.',
  },
  {
    slug: 'flooring-options-india',
    title: 'Flooring Options: Tiles vs Marble vs Wood',
    categorySlug: 'home-construction',
    excerpt: 'Cost, maintenance, and climate suitability.',
  },
  {
    slug: 'roofing-materials-guide',
    title: 'Roofing Materials Guide for Indian Homes',
    categorySlug: 'home-construction',
    excerpt: 'RCC, metal sheets, clay tiles, and waterproofing layers.',
  },
  {
    slug: 'plumbing-cost-house',
    title: 'Plumbing Cost for New House Construction',
    categorySlug: 'home-construction',
    excerpt: 'Fixtures, piping, and labour estimates per bathroom.',
  },
  {
    slug: 'electrical-wiring-cost',
    title: 'Electrical Wiring Cost per Sq Ft',
    categorySlug: 'home-construction',
    excerpt: 'Conduits, MCBs, points, and inverter readiness.',
  },
  {
    slug: 'interior-design-budget',
    title: 'Interior Design on a Budget',
    categorySlug: 'home-construction',
    excerpt: 'Prioritize kitchens, wardrobes, and lighting for maximum impact.',
  },
  {
    slug: 'cement-types-india',
    title: 'OPC vs PPC Cement: Which to Use?',
    categorySlug: 'home-construction',
    excerpt: 'Strength grades, setting time, and application areas.',
  },
  {
    slug: 'tmt-steel-buying-guide',
    title: 'TMT Steel Buying Guide',
    categorySlug: 'home-construction',
    excerpt: 'Fe 500 vs Fe 550D, brands, and weight verification.',
  },
  {
    slug: 'brick-vs-blocks',
    title: 'Red Bricks vs AAC Blocks',
    categorySlug: 'home-construction',
    excerpt: 'Thermal performance, cost, and build speed compared.',
  },
  {
    slug: 'waterproofing-terrace',
    title: 'Terrace Waterproofing Methods',
    categorySlug: 'home-construction',
    excerpt: 'Membranes, coatings, and slope correction basics.',
  },
  {
    slug: 'modular-kitchen-cost',
    title: 'Modular Kitchen Cost in India',
    categorySlug: 'home-construction',
    excerpt: 'Layouts, materials, appliances, and installation.',
  },
  {
    slug: 'bathroom-renovation-cost',
    title: 'Bathroom Renovation Cost Estimate',
    categorySlug: 'home-construction',
    excerpt: 'Tiles, fittings, plumbing changes, and labour.',
  },
  {
    slug: 'wpc-vs-plywood',
    title: 'WPC vs Plywood for Wardrobes',
    categorySlug: 'home-construction',
    excerpt: 'Moisture resistance, finish options, and price bands.',
  },
  {
    slug: 'solar-panel-cost-india',
    title: 'Solar Panel Installation Cost in India',
    categorySlug: 'solar-energy',
    excerpt: 'System size, subsidy, and payback period overview.',
  },
  {
    slug: 'on-grid-vs-off-grid-solar',
    title: 'On-Grid vs Off-Grid Solar Systems',
    categorySlug: 'solar-energy',
    excerpt: 'Net metering, batteries, and backup trade-offs.',
  },
  {
    slug: 'solar-subsidy-india',
    title: 'Rooftop Solar Subsidy Scheme Explained',
    categorySlug: 'solar-energy',
    excerpt: 'Central and state incentives for residential installs.',
  },
  {
    slug: 'inverter-battery-guide',
    title: 'Home Inverter and Battery Buying Guide',
    categorySlug: 'solar-energy',
    excerpt: 'VA rating, tubular vs lithium, and backup hours.',
  },
  {
    slug: 'mono-vs-poly-panels',
    title: 'Monocrystalline vs Polycrystalline Panels',
    categorySlug: 'solar-energy',
    excerpt: 'Efficiency, space, and cost for rooftop installs.',
  },
  {
    slug: 'honda-jazz-vs-baleno',
    title: 'Honda Jazz vs Maruti Baleno',
    categorySlug: 'automobiles',
    excerpt: 'Space, mileage, service costs, and resale compared.',
  },
  {
    slug: 'best-hatchback-under-10-lakh',
    title: 'Best Hatchbacks Under ₹10 Lakh',
    categorySlug: 'automobiles',
    excerpt: 'Swift, i20, Polo, and Jazz — value picks for 2026.',
  },
  {
    slug: 'suv-buying-guide-india',
    title: 'Compact SUV Buying Guide India',
    categorySlug: 'automobiles',
    excerpt: 'Ground clearance, safety, and diesel vs petrol.',
  },
  {
    slug: 'car-insurance-claim-process',
    title: 'Car Insurance Claim Process in India',
    categorySlug: 'automobiles',
    excerpt: 'Cashless garages, IDV, and zero-depreciation add-ons.',
  },
  {
    slug: 'ev-charging-home',
    title: 'Home EV Charging Setup Guide',
    categorySlug: 'automobiles',
    excerpt: 'AC chargers, load capacity, and installation cost.',
  },
  {
    slug: 'tyre-rotation-maintenance',
    title: 'Tyre Rotation and Alignment Guide',
    categorySlug: 'automobiles',
    excerpt: 'Extend tyre life and improve fuel efficiency.',
  },
  {
    slug: 'used-car-inspection-checklist',
    title: 'Used Car Inspection Checklist',
    categorySlug: 'automobiles',
    excerpt: 'Engine, body, documents, and test-drive tips.',
  },
  {
    slug: 'car-accessories-must-have',
    title: 'Must-Have Car Accessories for Indian Roads',
    categorySlug: 'automobiles',
    excerpt: 'Dash cams, seat covers, and safety essentials.',
  },
  {
    slug: 'diesel-vs-petrol-suv',
    title: 'Diesel vs Petrol SUV: Running Costs',
    categorySlug: 'automobiles',
    excerpt: 'Mileage, maintenance, and resale in city driving.',
  },
  {
    slug: 'car-loan-interest-rates',
    title: 'Car Loan Interest Rates Compared',
    categorySlug: 'automobiles',
    excerpt: 'Bank vs NBFC offers and processing fee traps.',
  },
  {
    slug: 'hybrid-cars-india',
    title: 'Strong Hybrid Cars in India Explained',
    categorySlug: 'automobiles',
    excerpt: 'Fuel savings, battery warranty, and tax benefits.',
  },
  {
    slug: 'rc-transfer-process',
    title: 'Vehicle RC Transfer Process',
    categorySlug: 'automobiles',
    excerpt: 'Documents, RTO fees, and online Parivahan steps.',
  },
  {
    slug: 'emi-calculator-how-to-use',
    title: 'How to Use an EMI Calculator Effectively',
    categorySlug: 'tools',
    excerpt: 'Principal, tenure, and rate scenarios to model before borrowing.',
  },
  {
    slug: 'gst-calculator-business',
    title: 'GST Calculator for Small Invoices',
    categorySlug: 'tools',
    excerpt: 'CGST, SGST, and IGST splits for goods and services.',
  },
  {
    slug: 'paint-calculator-room',
    title: 'Paint Calculator: Room-by-Room Guide',
    categorySlug: 'tools',
    excerpt: 'Doors, windows, and coat count adjustments.',
  },
  {
    slug: 'tile-calculator-bathroom',
    title: 'Tile Calculator for Bathrooms and Kitchens',
    categorySlug: 'tools',
    excerpt: 'Wastage percentage and skirting tile estimates.',
  },
  {
    slug: 'budget-planner-monthly',
    title: 'Monthly Budget Planner for Indian Households',
    categorySlug: 'tools',
    excerpt: '50-30-20 rule adapted for rent, EMIs, and savings.',
  },
];
...
const COMPARISON_SEEDS = [
  ...
  },
  {
    ...
    title: 'HDFC vs ICICI Personal Loan',
    left: 'HDFC Personal Loan',
    right: 'ICICI Personal Loan',
    comparisonType: 'product',
  },
  {
    slug: 'ultratech-vs-ambuja-cement',
    title: 'UltraTech vs Ambuja Cement',
    left: 'UltraTech OPC 53',
    right: 'Ambuja Cement',
    comparisonType: 'product',
  },
  {
    slug: 'creta-vs-seltos',
  ...
  },
  {
    ...
    title: 'Term vs Endowment Insurance',
    left: 'Term Life Plan',
    right: 'Endowment Plan',
    comparisonType: 'product',
  },
  {
    slug: 'flooring-tiles-vs-vitrified',
    title: 'Ceramic vs Vitrified Tiles',
    left: 'Ceramic Tiles',
    right: 'Vitrified Tiles',
    comparisonType: 'product',
  },
  {
    slug: 'inverter-lithium-vs-tubular',
    title: 'Lithium vs Tubular Inverter Battery',
    left: 'Lithium Battery',
    right: 'Tubular Battery',
    comparisonType: 'product',
  },
  {
    slug: 'sip-vs-lumpsum',
    ...
    left: 'Monthly SIP',
    right: 'One-Time Lumpsum',
    comparisonType: 'product',
  },
  {
    slug: 'petrol-vs-cng-car',
    title: 'Petrol vs CNG Car Ownership',
    left: 'Petrol Hatchback',
    right: 'Factory CNG Hatchback',
    comparisonType: 'vehicle',
  },
  {
    slug: 'plywood-vs-mdf',
    title: 'Plywood vs MDF for Furniture',
    left: 'Commercial Plywood',
    right: 'MDF Board',
    comparisonType: 'product',
  },
  {
    slug: 'split-vs-window-ac',
    title: 'Split AC vs Window AC',
    left: '1.5T Split AC',
    right: '1.5T Window AC',
    comparisonType: 'product',
  },
  {
    slug: 'ro-vs-uv-water-purifier',
    title: 'RO vs UV Water Purifier',
    left: 'RO Purifier',
    right: 'UV Purifier',
    comparisonType: 'product',
  },
  {
    slug: 'hybrid-vs-petrol-sedan',
    title: 'Hybrid vs Petrol Sedan',
    left: 'Strong Hybrid Sedan',
    right: 'Petrol Sedan',
    comparisonType: 'vehicle',
  },
  {
    slug: 'granite-vs-quartz-countertop',
    title: 'Granite vs Quartz Countertop',
    left: 'Granite Slab',
    right: 'Engineered Quartz',
    comparisonType: 'product',
  },
  {
    slug: 'fixed-vs-floating-home-loan',
    title: 'Fixed vs Floating Home Loan',
    left: 'Fixed Rate Loan',
    right: 'Floating Rate Loan',
    comparisonType: 'product',
  },
  {
    slug: 'ev-vs-petrol-city-commute',
    title: 'EV vs Petrol for City Commute',
    left: 'Electric Hatchback',
    right: 'Petrol Hatchback',
    comparisonType: 'vehicle',
  },
  {
    slug: 'asian-paints-vs-nerolac',
    title: 'Asian Paints vs Nerolac',
    left: 'Asian Paints',
    right: 'Nerolac Paints',
    comparisonType: 'product',
  },
] as const;
...
const REVIEW_SEEDS = [
  ...
  },
  {
    ...
    title: 'Best Water Purifiers for Indian Homes',
    score: 4.5,
    category: 'home-construction',
  },
  {
    slug: 'paint-sprayers',
    title: 'Best Paint Sprayers for DIY Projects',
    score: 4.3,
    category: 'tools',
  },
  {
    slug: 'solar-panels-home',
    title: 'Best Solar Panels for Rooftop Install',
    score: 4.6,
    category: 'solar-energy',
  },
  {
    slug: 'cctv-cameras',
    title: 'Best CCTV Cameras for Home Security',
    score: 4.2,
    category: 'tools',
  },
  {
    slug: 'car-tyres',
    title: 'Best Car Tyres for Indian Roads',
    score: 4.4,
    category: 'automobiles',
  },
  {
    slug: 'credit-cards-cashback',
  ...
  },
  {
    ...
    title: 'Best Kitchen Chimneys Under ₹15,000',
    score: 4.1,
    category: 'home-construction',
  },
  {
    slug: 'power-tools-drills',
    title: 'Best Cordless Drills for Home Use',
    score: 4.4,
    category: 'tools',
  },
  {
    slug: 'dash-cams',
    title: 'Best Dash Cams for Cars in India',
    score: 4.3,
    category: 'automobiles',
  },
  {
    slug: 'geysers',
    title: 'Best Geysers for Hard Water Areas',
    score: 4.2,
    category: 'home-construction',
  },
  {
    slug: 'mutual-funds-beginners',
    title: 'Best Mutual Funds for Beginners',
    score: 4.4,
    category: 'finance',
  },
  {
    slug: 'robot-vacuums',
    title: 'Best Robot Vacuums for Indian Homes',
    score: 4.0,
    category: 'tools',
  },
  {
    slug: 'car-seat-covers',
    title: 'Best Car Seat Covers Compared',
    score: 4.1,
    category: 'automobiles',
  },
  {
    slug: 'solar-inverters',
    title: 'Best Solar Inverters for On-Grid Systems',
    score: 4.5,
    category: 'solar-energy',
  },
  {
    slug: 'home-loan-banks',
    title: 'Best Banks for Home Loans in 2026',
    score: 4.4,
    category: 'finance',
  },
] as const;
