...
export const categories = [
  {
    ...
    links: [
      ...
      { label: 'Mutual Funds', href: '/finance/investments' },
      { label: 'Income Tax', href: '/calculators/income-tax' },
      { label: 'NPS & Retirement', href: '/calculators/retirement' },
    ],
    image:
  ...
  },
  {
    ...
    icon: 'car',
    links: [
      { label: 'Car Reviews', href: '/automobile/reviews' },
      { label: 'Maintenance Cost', href: '/automobile/maintenance' },
      { label: 'Accessories', href: '/automobile/vehicles' },
      { label: 'Tyres & Batteries', href: '/automobile/vehicles' },
      { label: 'Insurance', href: '/finance/insurance' },
      { label: 'Buying Guide', href: '/automobile/guides' },
    ],
    image:
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Inverters', href: '/reviews/solar-inverters' },
      { label: 'Battery Solutions', href: '/reviews/inverters' },
      { label: 'Government Subsidy', href: '/articles/solar-subsidy-india' },
      { label: 'Energy Saving Tips', href: '/articles/on-grid-vs-off-grid-solar' },
    ],
    image:
