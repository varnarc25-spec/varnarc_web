...
const TOOL: ConstructionPageKey = 'excavation-calculator';
...
export default async function ExcavationCalculatorPage() {
  ...
  return (
    <>
      ...
      />
      <AdvancedPlanningCalculatorClient tool="excavation" />
    </>
  );
}
