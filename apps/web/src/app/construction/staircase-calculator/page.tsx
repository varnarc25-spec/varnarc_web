...
const TOOL: ConstructionPageKey = 'staircase-calculator';
...
export default async function StaircaseCalculatorPage() {
  ...
  return (
    <>
      ...
      />
      <AdvancedPlanningCalculatorClient tool="staircase" />
    </>
  );
}
