...
const TOOL: ConstructionPageKey = 'false-ceiling-calculator';
...
export default async function FalseCeilingCalculatorPage() {
  ...
  return (
    <>
      ...
      />
      <AdvancedPlanningCalculatorClient tool="false-ceiling" />
    </>
  );
}
