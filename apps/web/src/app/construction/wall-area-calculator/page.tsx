...
const TOOL: ConstructionPageKey = 'wall-area-calculator';
...
export default async function WallAreaCalculatorPage() {
  ...
  return (
    <>
      ...
      />
      <AdvancedPlanningCalculatorClient tool="wall-area" />
    </>
  );
}
