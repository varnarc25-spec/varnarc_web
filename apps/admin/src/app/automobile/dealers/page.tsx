...
export default async function AutomobileDealersAdminPage() {
  const result = await apiServerFetch<DealersPayload>('/automobile/admin/dealers');
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Automobile dealers linked from the business directory."
      ...
      {result.error ? (
        <Card>
          <CardHeader>
            <CardTitle>Unable to load dealers</CardTitle>
        ...
        <>
          <Card className="mb-6">
            <CardHeader>
              ...
              <CardDescription>
                Businesses in these directory categories appear on the public dealers page.
              </CardDescription>
            </CardHeader>
            <div className="flex flex-wrap gap-2 px-6 pb-6">
              ...
              {!categories.length ? (
                <p className="text-sm text-[var(--varnarc-subtle)]">No automobile directory categories yet.</p>
              ) : null}
            </div>
          </Card>
                ...
                {!businesses.length ? (
                  <tr>
                    <td colSpan={5} className="px-4 py-8 text-center text-[var(--varnarc-subtle)]">
                      No linked dealers. Approve directory businesses in automobile categories to populate this list.
                    </td>
                  </tr>
                ) : null}
              </tbody>
