...
export function ConstructionListSearch({ defaultValue }: { defaultValue?: string }) {
  return (
    <form className="mb-6">
      <input
        name="search"
...
export function ConstructionCsvToolbar({ entity }: { entity: string }) {
  ...
  async function importCsv() {
    ...
    try {
      ...
      const res = await fetch(`/api/admin/construction/import/${entity}`, {
        method: 'POST',
        body: formData,
      });
