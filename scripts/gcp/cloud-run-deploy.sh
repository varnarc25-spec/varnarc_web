...
case "$SERVICE" in
  ...
  web)
    ...
    ENV_VARS="NODE_ENV=production,PORT=3000,APP_BASE_URL=${APP_BASE_URL},API_URL=${API_URL},NEXT_PUBLIC_ADSENSE_CLIENT=${NEXT_PUBLIC_ADSENSE_CLIENT:-ca-pub-6274053387170397}"
